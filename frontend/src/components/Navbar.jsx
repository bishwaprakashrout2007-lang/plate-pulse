...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-brand-yellow/80 dark:bg-brand-dark/80 backdrop-blur-md border-b border-brand-accent/10 dark:border-zinc-900 transition-colors duration-300">
